...
LdLearn, _ = InitLd(rng; NNwidth=10, sigma = tanh)
paramsVec0 = JSON.parsefile("1790_2023-07-28_13-50-55run_param_data.json")
paramsVec = Float64.(paramsVec0["learned_parameters"])
